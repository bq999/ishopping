...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://ishopping-258a0.firebaseio.com/"),
    refCart = new Firebase("https://ishopping-258a0.firebaseio.com/cart"),
    refUser = new Firebase("https://ishopping-258a0.firebaseio.com/users"),
    refCategory = new Firebase("https://ishopping-258a0.firebaseio.com/category"),
    refOrder = new Firebase("https://ishopping-258a0.firebaseio.com/orders"),
    refFeatured = new Firebase("https://ishopping-258a0.firebaseio.com/featured"),
    refMenu = new Firebase("https://ishopping-258a0.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
